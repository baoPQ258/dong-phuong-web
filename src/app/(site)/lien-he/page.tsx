...
export default function LienHePage() {
  const [form, setForm] = useState({ ho_ten: "", dien_thoai: "", email: "", noi_dung: "" });
    ...
    <div className="py-16">
      <div className="container-main">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          {/* Thông tin liên hệ */}
          <div>
            <h2 className="text-xl font-bold text-primary-700 mb-6">Thông tin liên hệ</h2>
            <ul className="space-y-5">
              {[
                { icon: MapPin, label: "Địa chỉ", value: "03 Hùng Vương, Phường Bàn Thạch, TP. Đà Nẵng" },
                { icon: Phone, label: "Điện thoại", value: "0236.xxx.xxxx" },
                { icon: Mail, label: "Email", value: "info@dongphuong.edu.vn" },
                { icon: Clock, label: "Giờ làm việc", value: "Thứ 2 – Thứ 7: 7:30 – 17:00" },
              ].map((item) => (
          ...
          <div className="bg-gray-50 rounded-2xl p-8">
            <h2 className="text-xl font-bold text-primary-700 mb-6">Gửi tin nhắn</h2>
